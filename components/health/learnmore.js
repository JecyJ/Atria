    ...
    <section className='relative w-full h-auto'>
        <div className='max-w-[520px] md:max-w-[1450px] m-auto'>
            <ul className='border-t border-t-[#3c4e3d] border-t-3  my-20'>
                ...
                <li className='relative md:z-[2] text-[#3c4e3d] text-5xl md:text-7xl font-semibold'>The Atria Health Collaborative engages the expertise, passion, and resources of the entire Atria team to improve healthcare at scale.</li>
            </ul>
