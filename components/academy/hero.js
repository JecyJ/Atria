...
const Hero = () => {
  return (
    <section className='grid content-center pt-48 w-full h-screen'>
      <div className='z-[-2]'>
        <Image src='/assets/images/stetoscope.png' alt='/' layout='fill' objectFit='cover' />
      </div>
      <div className='max-w-[520px] sm:max-w-[620px] md:max-w-[1250px] w-full m-auto space-y-6 text-white'>
