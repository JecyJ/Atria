...
const Scientists = () => {
  return (
    <section className='relative w-full h-auto'>
      <div className='relative z-[2] max-w-[520px] sm:max-w-[620px] md:max-w-[1450px] m-auto'>
      ...
      <div className='relative z-[-2] flex flex-cols max-w-[520px] md:max-w-[1450px] w-full m-auto mb-20'>
